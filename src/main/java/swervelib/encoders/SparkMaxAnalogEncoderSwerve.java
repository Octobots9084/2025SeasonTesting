...
public class SparkMaxAnalogEncoderSwerve extends SwerveAbsoluteEncoder {
  ...
  public SparkMaxAnalogEncoderSwerve(SwerveMotor motor, double maxVoltage) {
    ...
    if (motor.getMotor() instanceof SparkMax) {
      ...
      AnalogSensorConfig sensorConfig = new AnalogSensorConfig();
      sensorConfig.positionConversionFactor(360 / maxVoltage);


      
      SparkMaxConfig sparkMaxConfig = new SparkMaxConfig();
      sparkMaxConfig.analogSensor.apply(sensorConfig);
  ...
  public void configure(boolean inverted) {
    AnalogSensorConfig sensorConfig = new AnalogSensorConfig();
    sensorConfig.inverted(inverted);
